...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000173ff9ed000000002039bb72(
...
class phpbbtemplatetwiglexer_00000000173ff9ed000000002039bb72 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder590073e5e809a447090477 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer590073e5e80ae127896608 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties590073e5e8065382450252 = array(
    ...
    {
        $this->initializer590073e5e80ae127896608 && $this->initializer590073e5e80ae127896608->__invoke($this->valueHolder590073e5e809a447090477, $this, 'set_environment', array('env' => $env), $this->initializer590073e5e80ae127896608);

        return $this->valueHolder590073e5e809a447090477->set_environment($env);
    }
    ...
    {
        $this->initializer590073e5e80ae127896608 && $this->initializer590073e5e80ae127896608->__invoke($this->valueHolder590073e5e809a447090477, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer590073e5e80ae127896608);

        return $this->valueHolder590073e5e809a447090477->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer590073e5e80ae127896608 && $this->initializer590073e5e80ae127896608->__invoke($this->valueHolder590073e5e809a447090477, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer590073e5e80ae127896608);

        return $this->valueHolder590073e5e809a447090477->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer590073e5e80ae127896608 = $initializer;
    }
    ...
    {
        $this->initializer590073e5e80ae127896608 && $this->initializer590073e5e80ae127896608->__invoke($this->valueHolder590073e5e809a447090477, $this, '__get', array('name' => $name), $this->initializer590073e5e80ae127896608);

        if (isset(self::$publicProperties590073e5e8065382450252[$name])) {
            return $this->valueHolder590073e5e809a447090477->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder590073e5e809a447090477;
    ...
    {
        $this->initializer590073e5e80ae127896608 && $this->initializer590073e5e80ae127896608->__invoke($this->valueHolder590073e5e809a447090477, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer590073e5e80ae127896608);
    ...
    {
        $this->initializer590073e5e80ae127896608 && $this->initializer590073e5e80ae127896608->__invoke($this->valueHolder590073e5e809a447090477, $this, '__isset', array('name' => $name), $this->initializer590073e5e80ae127896608);
    ...
    {
        $this->initializer590073e5e80ae127896608 && $this->initializer590073e5e80ae127896608->__invoke($this->valueHolder590073e5e809a447090477, $this, '__unset', array('name' => $name), $this->initializer590073e5e80ae127896608);
    ...
    {
        $this->initializer590073e5e80ae127896608 && $this->initializer590073e5e80ae127896608->__invoke($this->valueHolder590073e5e809a447090477, $this, '__clone', array(), $this->initializer590073e5e80ae127896608);

        $this->valueHolder590073e5e809a447090477 = clone $this->valueHolder590073e5e809a447090477;
    }

    public function __sleep()
    {
        $this->initializer590073e5e80ae127896608 && $this->initializer590073e5e80ae127896608->__invoke($this->valueHolder590073e5e809a447090477, $this, '__sleep', array(), $this->initializer590073e5e80ae127896608);

        return array('valueHolder590073e5e809a447090477');
    }
    ...
    {
        return $this->initializer590073e5e80ae127896608;
    }
    ...
    {
        return $this->initializer590073e5e80ae127896608 && $this->initializer590073e5e80ae127896608->__invoke($this->valueHolder590073e5e809a447090477, $this, 'initializeProxy', array(), $this->initializer590073e5e80ae127896608);
    }
    ...
    {
        return null !== $this->valueHolder590073e5e809a447090477;
    }
    ...
    {
        return $this->valueHolder590073e5e809a447090477;
    }
