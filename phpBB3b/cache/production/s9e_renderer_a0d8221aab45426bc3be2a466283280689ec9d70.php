...
*/
class s9e_renderer_a0d8221aab45426bc3be2a466283280689ec9d70 extends \s9e\TextFormatter\Renderer
{
	...
	protected static $tagBranches=array('ATTACHMENT'=>0,'B'=>1,'CODE'=>2,'COLOR'=>3,'E'=>4,'EMAIL'=>5,'EMOJI'=>6,'FLASH'=>7,'I'=>8,'IMG'=>9,'IRC'=>10,'LI'=>11,'LINK_TEXT'=>12,'LIST'=>13,'QUOTE'=>14,'SIZE'=>15,'U'=>16,'URL'=>17,'br'=>18,'e'=>19,'i'=>19,'s'=>19,'p'=>20);
	...
	protected function renderQuick($xml)
	{
		...
		$html = preg_replace_callback(
			'(<(?:(?!/)((?:ATTACHMENT|E(?>MOJI)?|IRC|LINK_TEXT))(?: [^>]*)?>.*?</\\1|(/?(?!br/|p>)[^ />]+)[^>]*?(/)?)>)s',
			array($this, 'quick'),
			preg_replace(
				'(<[eis]>[^<]*</[eis]>)',
				'',
